...
(function () {
  ...
  var ROUTES = {
    ...
    ski_ring: {
      ...
      track: [
        [55.0084, 82.9357],   // Новосибирск
        [54.48, 83.85],       // ГЛК Юрманка
        [51.996, 84.984],     // Белокуриха
        [51.952, 84.874],     // Белокуриха-2
        [52.294, 85.65],      // Озеро Светлое (Лебединое)
        [51.832, 85.779],     // Манжерок
        [51.7416, 87.2955],   // ГЛК Телецкий
        [52.9532, 87.956],    // Шерегеш
        [54.808, 85.005],     // ГЛК Танай
        [55.0084, 82.9357]   // Новосибирск
      ],
      waypoints: [
        { coords: [54.48, 83.85], title: 'ГЛК Юрманка — гора Глухариная, Маслянинский р-н, трассы и прокат', type: 'sight' },
        { coords: [51.996, 84.984], title: 'Белокуриха — горнолыжный курорт (Мишина гора), вечернее катание', type: 'sight' },
        { coords: [51.952, 84.874], title: 'Белокуриха-2 — горнолыжный кластер, отдельный склон', type: 'sight' },
        { coords: [52.294, 85.65], title: 'Озеро Светлое (Лебединое) — заказник, зимовка лебедей-кликунов', type: 'sight' },
        { coords: [51.832, 85.779], title: 'Манжерок — курорт, канатная дорога на Синюху, трассы у Катуни', type: 'sight' },
        { coords: [51.7416, 87.2955], title: 'ГЛК Телецкий — гора Кокуя, Артыбаш, трассы у Телецкого озера', type: 'sight' },
        { coords: [52.9532, 87.956], title: 'Шерегеш — гора Зелёная, горнолыжный курорт, освещённые трассы', type: 'sight' },
        { coords: [54.808, 85.005], title: 'ГЛК Танай — гора Слизун, Журавлево, завершение кольца', type: 'sight' }
      ]
    },
    krasnoyarsk_ergaki: {
      center: [54.5, 92.0],
