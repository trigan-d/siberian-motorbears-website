  ...
  var ROUTES = {
    ...
    ski_ring: {
      ...
      track: [
        ...
        [51.9722, 84.9277],   // Белокуриха — гора Церковка (815 м)
        [51.9458, 84.891],    // Белокуриха-2 — гора Мишина
        [52.294, 85.65],      // Озеро Светлое (Лебединое)
        [51.832, 85.779],     // Манжерок — гора Синюха (1020–1240 м)
        [51.7416, 87.2955],   // Телецкий — гора Кокуя (1050 м)
        [52.9532, 87.956],    // Шерегеш — горы Мустаг (1570 м), Зелёная (1270 м), Утуя (1143 м)
        [54.7052, 85.031],    // Танай — гора Слизун
        [55.0084, 82.9357]   // Новосибирск
      ],
      waypoints: [
        { coords: [54.48, 83.85], title: 'Юрманка — гора Копна (388 м), Маслянинский р-н, трассы и прокат', type: 'sight' },
        { coords: [51.9722, 84.9277], title: 'Белокуриха — гора Церковка (815 м), канатка, терренкуры, минеральные источники', type: 'sight' },
        { coords: [51.9458, 84.891], title: 'Белокуриха-2 — гора Мишина (~800 м), трассы, бугельный подъёмник', type: 'sight' },
        { coords: [52.294, 85.65], title: 'Озеро Светлое (Лебединое) — заказник, зимовка лебедей-кликунов', type: 'sight' },
        { coords: [51.832, 85.779], title: 'Манжерок — гора Синюха (1020–1240 м), канатная дорога, освещённые трассы, вечернее катание', type: 'sight' },
        { coords: [51.7416, 87.2955], title: 'Телецкий — гора Кокуя (1050 м), Артыбаш, трассы у Телецкого озера', type: 'sight' },
        { coords: [52.9532, 87.956], title: 'Шерегеш — горы Мустаг (1570 м), Зелёная (1270 м), Утуя (1143 м), освещённые трассы', type: 'sight' },
        { coords: [54.7052, 85.031], title: 'Танай — гора Слизун, Журавлево, ГЛК Танай, завершение кольца', type: 'sight' }
      ]
    },
    krasnoyarsk_ergaki: {
      center: [54.5, 92.0],
    ...
    baikal: {
      ...
      track: [
        ...
        [52.28, 104.28], [51.857, 104.862], [52.28, 104.28], [51.83, 107.58],
      ...
      waypoints: [
        ...
        { coords: [52.28, 104.28], title: 'Иркутск — исторический центр, юг Байкала', type: 'sight' },
        ...
        { coords: [51.83, 107.58], title: 'Улан-Удэ — стоянка, выезд на север Байкала', type: 'stop' },
        { coords: [55.65, 109.32], title: 'Северобайкальск — север Байкала, БАМ', type: 'sight' },
        { coords: [56.13, 101.61], title: 'Братск — стоянка, Братское водохранилище', type: 'stop' }
      ]
    },
    crimea: {
      center: [51.0, 58.0],
    ...
    vladivostok: {
      ...
      track: [
        ...
        [42.82, 132.87], [43.12, 131.87], [48.48, 135.07], [50.55, 137.01], [48.48, 135.07],
        [52.03, 113.50], [51.83, 107.58], [52.28, 104.28], [56.015, 92.893], [55.0084, 82.9357]
      ],
      waypoints: [
        { coords: [55.35, 86.09], title: 'Кемерово — стоянка в пути', type: 'stop' },
        { coords: [56.015, 92.893], title: 'Красноярск — стоянка', type: 'stop' },
        ...
        { coords: [50.55, 137.01], title: 'Комсомольск-на-Амуре — заезд от Хабаровска (~400 км), Амур', type: 'stop' },
    ...
    karelia_teriberka: {
      ...
      track: [
        ...
        [58.60, 49.66],              // Киров
        [59.22, 39.88],              // Вологда
        [61.78, 34.35],              // Петрозаводск (Карелия)
        [68.97, 33.08],              // Мурманск
        [69.20, 35.12],              // Териберка (Баренцево море)
        [68.97, 33.08],              // Мурманск (обратно)
        [61.78, 34.35],              // Петрозаводск
        [59.22, 39.88],              // Вологда
        [58.60, 49.66],              // Киров
        [58.01, 56.25],              // Пермь
        [56.84, 60.61],              // Екатеринбург
      ...
      waypoints: [
        { coords: [54.99, 73.37], title: 'Омск — стоянка в пути', type: 'stop' },
        { coords: [57.15, 65.53], title: 'Тюмень — транзит, заправки', type: 'stop' },
        { coords: [56.84, 60.61], title: 'Екатеринбург — стоянка, граница Европы и Азии', type: 'stop' },
        { coords: [58.01, 56.25], title: 'Пермь — транзит по трассе', type: 'stop' },
        { coords: [58.60, 49.66], title: 'Киров — стоянка в пути', type: 'stop' },
        { coords: [59.22, 39.88], title: 'Вологда — транзит к Карелии', type: 'stop' },
        { coords: [61.78, 34.35], title: 'Петрозаводск — стоянки, Онежское озеро, Кижи (теплоход)', type: 'stop' },
        { coords: [61.78, 34.35], title: 'Карелия — озёра, водопады Кивач, Рускеала, горный парк', type: 'sight' },
        { coords: [68.97, 33.08], title: 'Мурманск — стоянка, Кольский залив, выезд в Териберку', type: 'stop' },
        { coords: [69.20, 35.12], title: 'Териберка — Баренцево море, северное сияние, «Левиафан»', type: 'sight' }
      ]
    },
    tobolsk_salekhard: {
      center: [61.5, 70.0],
      ...
      track: [
        [55.0084, 82.9357],           // Новосибирск
        [54.99, 73.37],               // Омск
        [57.9347, 69.0133],           // Вагай (дорога Омск — Тобольск без Тюмени)
        [58.1984, 68.2546],           // Тобольск
        [61.0042, 69.0015],           // Ханты-Мансийск
        [61.25, 73.4167],             // Сургут
        [66.53, 66.6019],             // Салехард (ЯНАО, Полярный круг)
        [61.25, 73.4167],             // Сургут (обратно)
        [58.1984, 68.2546],           // Тобольск
        [57.9347, 69.0133],           // Вагай
        [54.99, 73.37],               // Омск
        [55.0084, 82.9357]            // Новосибирск
      ],
      waypoints: [
        { coords: [54.99, 73.37], title: 'Омск — стоянка в пути', type: 'stop' },
        { coords: [57.9347, 69.0133], title: 'Вагай — транзит (дорога Омск–Тобольск, без заезда в Тюмень)', type: 'stop' },
        { coords: [58.1984, 68.2546], title: 'Тобольск — кремль, история Сибири, стоянки', type: 'sight' },
        { coords: [61.0042, 69.0015], title: 'Ханты-Мансийск — столица Югры, Иртыш, стоянки', type: 'stop' },
        { coords: [61.0042, 69.0015], title: 'Ханты-Мансийск — музей природы, Археопарк, лыжные трассы', type: 'sight' },
        { coords: [61.25, 73.4167], title: 'Сургут — нефтегазовая столица, Обь, стоянки', type: 'stop' },
        { coords: [66.53, 66.6019], title: 'Салехард — столица ЯНАО, Полярный круг, переправа через Обь', type: 'sight' }
      ]
    }
  };
