...
const TRACKS = {
  ...
  // baikal: туда по М53 до Иркутска/Листвянки, обратно через Улан-Удэ → Северобайкальск → Братск → Красноярск
  baikal: [
    [55.0084, 82.9357], [55.35, 86.09], [56.015, 92.893], [55.94, 98.00], [52.28, 104.28], [51.857, 104.862], [52.28, 104.28],
    [51.83, 107.58], [54.0, 108.3], [55.65, 109.32], [56.8, 105.72], [56.13, 101.61], [55.95, 98.0], [56.015, 92.893], [55.0084, 82.9357]
  ],
  ...
  // vladivostok: один путь туда и обратно (без северного варианта через Братск)
  vladivostok: [
    ...
    [42.82, 132.87], [43.12, 131.87], [43.8, 131.95], [48.48, 135.07], [50.55, 137.01], [48.48, 135.07], [50.29, 127.53], [52.03, 113.50], [51.83, 107.58], [52.28, 104.28], [56.015, 92.893], [55.0084, 82.9357]
  ],
  karelia_teriberka: [
    [55.0084, 82.9357], [54.99, 73.37], [57.15, 65.53], [56.84, 60.61], [58.01, 56.25], [58.60, 49.66], [59.22, 39.88], [61.78, 34.35], [68.97, 33.08], [69.20, 35.12],
    [68.97, 33.08], [61.78, 34.35], [59.22, 39.88], [58.60, 49.66], [58.01, 56.25], [56.84, 60.61], [57.15, 65.53], [54.99, 73.37], [55.0084, 82.9357]
  ],
  // туда: Нск → Тобольск → Ханты-Мансийск → Сургут → Салехард; обратно без Ханты-Мансийска: Сургут → Тобольск → Тюмень → Нск
  tobolsk_salekhard: [
    [55.0084, 82.9357], [54.99, 73.37], [57.15, 65.53], [58.1984, 68.2546], [61.0042, 69.0015], [61.25, 73.4167], [66.53, 66.6019],
    [61.25, 73.4167], [58.1984, 68.2546], [57.15, 65.53], [54.99, 73.37], [55.0084, 82.9357]
  ],
  // Горнолыжное кольцо Сибири: НСК → ГЛК Юрманка → Белокуриха → Белокуриха-2 → Манжерок → ГЛК Телецкий → Шерегеш → ГЛК Танай → НСК
  ski_ring: [
    [55.0084, 82.9357],   // Новосибирск
    [54.48, 83.85],       // ГЛК Юрманка (Верх-Ики, гора Глухариная, Маслянинский р-н)
    [51.996, 84.984],     // Белокуриха (горнолыжный курорт)
    [51.952, 84.874],     // Белокуриха-2 (горнолыжный кластер)
    [52.294, 85.65],      // Озеро Светлое (Лебединое), заказник — зимовка лебедей
    [51.832, 85.779],     // Манжерок (курорт, канатка на Синюху)
    [51.7416, 87.2955],   // ГЛК Телецкий (Артыбаш, гора Кокуя)
    [52.9532, 87.956],    // Шерегеш (гора Зелёная, ГЛК)
    [54.808, 85.005],     // ГЛК Танай (Журавлево, гора Слизун)
    [55.0084, 82.9357]    // Новосибирск
  ]
};
