...
const TRACKS = {
  ...
  // туда: Нск → Омск → Вагай → Тобольск → Ханты-Мансийск → Сургут → Салехард; обратно: Сургут → Тобольск → Вагай → Омск → Нск (без Тюмени)
  tobolsk_salekhard: [
    [55.0084, 82.9357], [54.99, 73.37], [57.9347, 69.0133], [58.1984, 68.2546], [61.0042, 69.0015], [61.25, 73.4167], [66.53, 66.6019],
    [61.25, 73.4167], [58.1984, 68.2546], [57.9347, 69.0133], [54.99, 73.37], [55.0084, 82.9357]
  ],
  ...
  ski_ring: [
    ...
    [54.48, 83.85],       // Юрманка — гора Копна
    [51.9722, 84.9277],   // Белокуриха — гора Церковка
    [51.9458, 84.891],    // Белокуриха-2 — гора Мишина
    [52.294, 85.65],      // Озеро Светлое (Лебединое)
    [51.832, 85.779],     // Манжерок — гора Синюха
    [51.7416, 87.2955],   // Телецкий — гора Кокуя
    [52.9532, 87.956],    // Шерегеш — горы Мустаг, Зелёная, Утуя
    [54.7052, 85.031],    // Танай — гора Слизун
    [55.0084, 82.9357]    // Новосибирск
  ]
};
